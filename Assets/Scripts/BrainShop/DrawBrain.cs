...
public class DrawBrain
{
   ...
   public static BrainStatistics DrawRandomBrain()
   {
      ...
      brainStatistics.cost = Mathf.FloorToInt(Mathf.Pow(1+statPoint, 1.2f) * costPerSkill * Mathf.Pow(Mathf.Max(1f, LoopManager.instance.currentDay), 1.15f) * Random.Range(0.9f, 1.1f));
